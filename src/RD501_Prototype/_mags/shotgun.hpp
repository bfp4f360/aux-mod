class macro_new_mag(shotgun_test,20): 2Rnd_12Gauge_Pellets
{
    author = "RD501";
    scope = 2;
...
class macro_new_mag(shotgun_test,2): macro_new_mag(shotgun_test,20)
{
    count = 2;
...
class macro_new_mag(dc15_gl_shotgun,2): macro_new_mag(shotgun_test,20)
{
    count = 2;
    ammo = macro_new_ammo(shotgun_submunition_carbine)
